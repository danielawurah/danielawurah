...
|---|---|---|---|---|
| [**Enterprise ABAC & Lifecycle Automation**](https://github.com/danielawurah/danielawurah/tree/main/abac-lifecycle-automation) | Runbook & Screenshots | Zero-Touch JML automation that maps HR attributes to dynamic group memberships for automatic Birthright Access provisioning and revocation. | Okta · AD · ABAC · SCIM · PowerShell | ![Complete](https://img.shields.io/badge/Complete-2ea44f?style=flat-square) |
| [**Identity Governance & Segregation of Duties**](https://github.com/danielawurah/danielawurah/tree/main/identity-governance-sod) | Audit Logs & Screenshots | Mitigates Privilege Creep and Insider Threat via SoD enforcement and simulated Access Certification campaign aligned to Least Privilege. | Okta · SailPoint · Access Reviews · Audit Logs | ![Complete](https://img.shields.io/badge/Complete-2ea44f?style=flat-square) |
| [**Privileged Access Management (PAM) & Just-in-Time Access**](https://github.com/danielawurah/danielawurah/tree/main/pam-jit-access) | Screenshots | JIT access workflow where elevated privileges are requested, approved and auto-expired, eliminating standing access and reducing blast radius. | Okta · Entra ID · PIM · JIT · Approval Workflow | ![Complete](https://img.shields.io/badge/Complete-2ea44f?style=flat-square) |
| [**Identity-Centric Zero Trust Network Access (ZTNA)**](https://github.com/danielawurah/danielawurah/tree/main/zero-trust-ztna) | Architecture Diagram & Screenshots | Replaces traditional VPN with Cloudflare Tunnel to enforce identity-verified, least-privilege access to internal AD resources without public internet exposure. | AD · Cloudflare Zero Trust · ZTNA · Cloudflare Tunnel · MFA | ![Complete](https://img.shields.io/badge/Complete-2ea44f?style=flat-square) |
| [**REST API Automation & Bulk Identity Provisioning**](https://github.com/danielawurah/danielawurah/tree/main/bulk-identity-provisioning) | Postman Collections · JSON · Console Screenshots | Programmatic identity lifecycle management via REST APIs, covering bulk user creation, attribute manipulation and failed provisioning troubleshooting at scale. | Okta · Entra ID API · Postman · REST · JSON | ![Complete](https://img.shields.io/badge/Complete-2ea44f?style=flat-square) |
| [**SAML Integration with Service Provider (Salesforce)**](https://github.com/danielawurah/danielawurah/tree/main/saml-okta-salesforce) | Screenshots | Foundational SSO configuration using SAML 2.0 that establishes identity federation between Okta and a third-party SaaS application. | Okta · SAML 2.0 · Salesforce | ![Complete](https://img.shields.io/badge/Complete-2ea44f?style=flat-square) |
