...
| [**Privileged Access Management (PAM) & Just-in-Time Access**](https://github.com/danielawurah/pam-jit-access) | Screenshots & Video | JIT access workflow where elevated privileges are requested, approved and auto-expired, eliminating standing access and reducing blast radius. | Okta · Entra ID · PIM · JIT · Approval Workflow | ![Complete](https://img.shields.io/badge/Complete-2ea44f?style=flat-square) |
