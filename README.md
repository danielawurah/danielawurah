...
|---|---|---|---|---|
| [**Enterprise ABAC & Lifecycle Automation**](https://github.com/danielawurah/danielawurah/blob/main/abac-lifecycle-automation/README.md) | Runbook & Screenshots | Zero-Touch JML automation that maps HR attributes to dynamic group memberships for automatic Birthright Access provisioning and revocation. | Okta · AD · ABAC · SCIM · PowerShell | ![Complete](https://img.shields.io/badge/Complete-2ea44f?style=flat-square) |
| [**Identity Governance & Segregation of Duties**](https://github.com/danielawurah/danielawurah/blob/main/identity-governance-sod/README.md) | Audit Logs & Screenshots | Mitigates Privilege Creep and Insider Threat via SoD enforcement and simulated Access Certification campaign aligned to Least Privilege. | Okta · SailPoint · Access Reviews · Audit Logs | ![Complete](https://img.shields.io/badge/Complete-2ea44f?style=flat-square) |
| [**Privileged Access Management (PAM) & Just-in-Time Access**](https://github.com/danielawurah/danielawurah/blob/main/pam-jit-access/README.md) | Screenshots | JIT access workflow where elevated privileges are requested, approved and auto-expired, eliminating standing access and reducing blast radius. | Okta · Entra ID · PIM · JIT · Approval Workflow | ![Complete](https://img.shields.io/badge/Complete-2ea44f?style=flat-square) |
| [**Identity-Centric Zero Trust Network Access (ZTNA)**](https://github.com/danielawurah/danielawurah/blob/main/zero-trust-ztna/README.md) | Architecture Diagram & Screenshots | Replaces traditional VPN with Cloudflare Tunnel to enforce identity-verified, least-privilege access to internal AD resources without public internet exposure. | AD · Cloudflare Zero Trust · ZTNA · Cloudflare Tunnel · MFA | ![Complete](https://img.shields.io/badge/Complete-2ea44f?style=flat-square) |
| [**REST API Automation & Bulk Identity Provisioning**](https://github.com/danielawurah/danielawurah/blob/main/bulk-identity-provisioning/README.md) | Postman Collections · JSON · Console Screenshots | Programmatic identity lifecycle management via REST APIs, covering bulk user creation, attribute manipulation and failed provisioning troubleshooting at scale. | Okta · Entra ID API · Postman · REST · JSON | ![Complete](https://img.shields.io/badge/Complete-2ea44f?style=flat-square) |
| [**SAML Integration with Service Provider (Salesforce)**](https://github.com/danielawurah/danielawurah/blob/main/saml-okta-salesforce/README.md) | Screenshots | Foundational SSO configuration using SAML 2.0 that establishes identity federation between Okta and a third-party SaaS application. | Okta · SAML 2.0 · Salesforce | ![Complete](https://img.shields.io/badge/Complete-2ea44f?style=flat-square) |
...
| Workflow Project | Proof | Purpose | Stack | Status |
|---|---|---|---|---|
| [**NHI-Sentinel: Non-Human Identity & Workload Auditor**](https://github.com/danielawurah/danielawurah/blob/main/nhi-sentinel/README.md) | Discovery Report (PDF) · GitHub Repo · Before/After Privilege Comparison | Automates the discovery and lifecycle auditing of service accounts, bots, and API keys to eliminate **Shadow Identities** and orphaned credentials across cloud and SaaS environments. | Python · Microsoft Graph API · Okta API · TruffleHog · PostgreSQL | ![70% Complete](https://img.shields.io/badge/70%25_Complete-f0a500?style=flat-square) |
| [**Locally Hosted AI for Enterprise (Air-Gapped LLM)**](https://github.com/danielawurah/danielawurah/blob/main/locally-hosted-ai/README.md) | Screenshots · Architecture Diagram | Deploys and governs a self-hosted large language model for internal enterprise use, keeping sensitive data off public AI endpoints, enforcing access controls and establishing AI usage policy. | Ollama · Hugging Face · Local inference · AI Governance Policy | ![Queued](https://img.shields.io/badge/Queued-888888?style=flat-square) |
