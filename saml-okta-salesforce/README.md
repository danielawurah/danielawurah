<h1 align="center">SAML 2.0 SSO Integration — Okta & Salesforce</h1>
...
- Validated **IdP-initiated SSO** — logged in via Okta dashboard, clicked Salesforce app, landed in Salesforce session
...
- **SAML 2.0 SP-Initiated & IdP-Initiated flows** — Understanding both directions of the auth handshake
- **AD as Source of Truth** — All identity data originates from AD, flows through Okta, reaches Salesforce
